...
class VolleyballMatch {
    ...
    setupTeams() {
        ...
        selectHomeTeam.addEventListener('change', () => this.setImageLogo(selectHomeTeam, imageLogoHome, 'homelogo'));
        selectAwayTeam.addEventListener('change', () => this.setImageLogo(selectAwayTeam, imageLogoAway, 'awaylogo'));

        selectHomeTeam.addEventListener('change', () => this.makeKickOffBtnEnabled(selectHomeTeam, selectAwayTeam));
        selectAwayTeam.addEventListener('change', () => this.makeKickOffBtnEnabled(selectHomeTeam, selectAwayTeam));

        selectHomeTeam.addEventListener('change', () => this.removeTeamFromList(selectHomeTeam, selectAwayTeam));
        selectAwayTeam.addEventListener('change', () => this.removeTeamFromList(selectAwayTeam, selectHomeTeam));

        selectHomeTeam.addEventListener('change', () => this.storeSelectedTeamInnerText(selectHomeTeam, '.a'));
        selectAwayTeam.addEventListener('change', () => this.storeSelectedTeamInnerText(selectAwayTeam, '.b'));

        selectHomeTeam.addEventListener('change', () => this.storeSelectedTeamInnerText(selectHomeTeam, '.t1s'));
        selectAwayTeam.addEventListener('change', () => this.storeSelectedTeamInnerText(selectAwayTeam, '.t2s'));
    ...
    disableKickOff() {
        const kickOff = document.querySelector('.kick-off');
        kickOff.disabled = true;
        kickOff.style.backgroundColor = 'rgb(242, 220, 147)';
    ...
    setupTimeOut() {
        ...
        timeoutBtn2.addEventListener('click', () => {
            timeoutBtn2.disabled = true;
            timeoutBtn2.innerText = `Available once Set ${currSet.value} is done`;
            timeoutBtn2.style.justifyContent = 'center';
            j++;
